const {
    ...
    getUserById,
    getTransactionDetailsById, // Make sure this is imported from your dbQueries
  } = require("../db/dbQueries")
  
  // Import email controller - make sure this path is correct
  ...
  const approveRegistration = async (req, res) => {
    ...
    try {
      ...
      // Generate a unique registration number (E-Tag)
