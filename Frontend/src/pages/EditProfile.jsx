...
const EditProfile = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    Name: '',
    Email: '',
    Password: '', // This will hold the new password or be left unchanged
    cnic: '',
    PhoneNumber: '',
    AddressDetails: '',
    ProfilePicture: '',
  });
  const [originalPassword, setOriginalPassword] = useState(''); // To store the original password
        ...
        if (userId) {
          ...
          axios
            ...
            .then((response) => {
              ...
              setOriginalPassword(userData.password); // Assuming backend sends hashed password
            })
            .catch((err) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/user-dashboard', { state: { successMessage: 'Profile updated successfully!' } });
    } catch (err) {
