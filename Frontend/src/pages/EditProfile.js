...
import { FaUser, FaEnvelope, FaLock, FaIdCard, FaPhone, FaHome, FaImage } from "react-icons/fa";
...
const EditProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const updatedFormData = { ...formData, Password: formData.Password.trim() ? formData.Password : originalPassword };
