...
import { FaCheckCircle, FaShieldAlt, FaClock, FaChevronDown, FaArrowRight } from 'react-icons/fa';
import { AiOutlineMenu } from 'react-icons/ai';

const TriangleBackground = () => (
  <svg className="absolute inset-0 w-full h-full z-0" xmlns="http://www.w3.org/2000/svg">
    <pattern id="triangles" width="50" height="43.3" patternUnits="userSpaceOnUse" patternTransform="scale(2)">
      <path d="M25 0 L50 43.3 L0 43.3 Z" fill="none" stroke="#F38120" strokeOpacity="0.1" />
    </pattern>
...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-gray-200 bg-opacity-90 backdrop-blur-md shadow-md z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="#" className="flex items-center">
              <img src="/SC.png" alt="Logo" className="h-12 w-auto sm:h-14" />
              <span className="ml-2 text-xl font-bold text-[#F38120]">SecureChain</span>
            </a>
          </div>
          ...
          <nav className="hidden md:flex space-x-10">
            <a href="#hero" className="text-base font-medium text-gray-500 hover:text-gray-900">Platform</a>
            <a href="#features" className="text-base font-medium text-gray-500 hover:text-gray-900">About us</a>
            <a href="#join-us" className="text-base font-medium text-gray-500 hover:text-gray-900">Contact</a>
          </nav>
        ...
        {navOpen && (
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1">
              <a href="#hero" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-300">Platform</a>
              <a href="#features" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-300">About us</a>
              <a href="#join-us" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-300">Contact</a>
            </div>
            <div className="px-5 py-4 border-t border-gray-300">
              <a href="/signin" className="block text-center w-full px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-[#F38120] bg-gray-100 hover:bg-gray-200">
                Sign in
              </a>
              <a href="/signup" className="block text-center w-full px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-[#F38120] hover:bg-[#e0701c] mt-3">
                Sign up
              </a>
            </div>
          </motion.div>
...
const FuturisticLandingPage = () => {
  ...
  return (
    <div className="landing-page bg-gray-100 min-h-screen text-gray-800">
      ...
      {/* Hero Section */}
      <section id="hero" className="relative pt-20 pb-32 flex content-center items-center justify-center min-h-screen">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="flex flex-wrap items-center">
            <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              ...
              >
                A New Era of <span className="text-[#F38120]">Vehicle Registration</span>
              </motion.h1>
              <motion.p 
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#4A4D52" fillOpacity="1" d="M0,96L48,112C96,128,192,160,288,160C384,160,480,128,576,122.7C672,117,768,139,864,154.7C960,171,1056,181,1152,165.3C1248,149,1344,107,1392,85.3L1440,64L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
          </svg>
        </div>
      </section>
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  >
                    <polygon
                      ...
                      className="text-[#F38120] fill-current"
                    ></polygon>
                  </svg>
                  ...
                  <p className="text-md font-light mt-2 text-white">
                    Be part of the revolution in vehicle registration. Together, we can create a more secure and efficient future.
                  </p>
                </blockquote>
              </motion.div>
            </div>
      ...
      <footer className="relative bg-[#4A4D52] pt-8 pb-6">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="flex flex-wrap text-center lg:text-left">
            <div className="w-full lg:w-6/12 px-4">
              <h4 className="text-3xl font-semibold text-[#F38120]">Let's keep in touch!</h4>
              ...
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a className="text-gray-200 hover:text-white font-semibold block pb-2 text-sm" href="#about-us">About Us</a>
                    </li>
                    <li>
                      <a className="text-gray-200 hover:text-white font-semibold block pb-2 text-sm" href="#blog">Blog</a>
                    </li>
                    <li>
                      <a className="text-gray-200 hover:text-white font-semibold block pb-2 text-sm" href="#github">Github</a>
                    </li>
                  </ul>
                </div>
                <div className="w-full lg:w-4/12 px-4">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a className="text-gray-200 hover:text-white font-semibold block pb-2 text-sm" href="#terms">Terms & Conditions</a>
                    </li>
                    <li>
                      <a className="text-gray-200 hover:text-white font-semibold block pb-2 text-sm" href="#privacy">Privacy Policy</a>
                    </li>
                    <li>
                      <a className="text-gray-200 hover:text-white font-semibold block pb-2 text-sm" href="#contact-us">Contact Us</a>
                    </li>
                  </ul>
                </div>
              </div>
